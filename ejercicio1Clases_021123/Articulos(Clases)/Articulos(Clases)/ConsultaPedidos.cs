 ...
 */
        ...
        {
            pedido.CodPedido = listaPedidos.Count + 1;
        ...
        {
            var pedidoExistente = listaPedidos.FirstOrDefault(p => p.CodPedido == pedido.CodPedido);
        ...
        // Eliminar un pedido
        private void EliminarPedido(int codPedido)
        {
            listaPedidos.RemoveAll(p => p.CodPedido == codPedido);
        }
    }
}
